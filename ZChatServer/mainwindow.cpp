    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->labelWinTitle->setText(tr("即时通讯软件后台"));
...
void MainWindow::InitNetwork()
{
    ...
    connect(tcpMsgServer, SIGNAL(signalDownloadFile(QJsonValue))
            , tcpFileServer, SLOT(SltClientDownloadFile(QJsonValue)));
    connect(tcpMsgServer, SIGNAL(signalUserStatus(QString))
            , this, SLOT(ShowUserStatus(QString)));
    connect(tcpFileServer, SIGNAL(signalUserStatus(QString))
            , this, SLOT(ShowUserStatus(QString)));
}
